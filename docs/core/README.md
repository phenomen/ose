...
### Модули правил
#### Основные правила
В книге, которую вы сейчас читаете, содержаться основные правила игры, подходящие к любому миру, жанру и стилю. У всех игроков должен быть доступ к этой книге. Лучше всего, если у каждого будет своя копия.

#### Жанровые правила
Содержат правила игры для определённого жанра фантастики (фэнтези, научная фантастика, паропанк и т.п.), в котором происходит действие игры. В книгах жанровых правил обычно описываются классы авантюристов, а также оружие, доспехи, средства передвижения и услуги. У всех игроков должен быть доступ к книге жанровых правил, которая используются всей группой.

#### Заклинания
Список магических заклинаний, которые могут быть использованы некоторыми классами из соответствующих жанровых правил. Эта книга требуется только игрокам, чей персонаж имеет доступ к заклинаниям.

#### Монстры
Список противников и чудовищ, которые могут встретиться во время приключений в рамках определённого мира и жанра. Книга монстров требуется только рефери.

#### Сокровища
Список чудесных и ценных предметов, которые могут быть найдены во время приключений в рамках определённого мира и жанра. Книга сокровищ требуется только рефери.
