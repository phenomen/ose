...
- **Проверки атаки:** Вместо использовании матрицы (см. [Матрица атак по ЧПОКБ0](temp)), проверки атаки используют бонус атаки к броску d20 (см. [Бой](temp)).
...
Бросьте 3d6 для каждой характеристики: Силы, Интеллекта, Мудрости, Ловкости, Выносливости и Харизмы. См. [Характеристики](temp) для подробного описания каждой.
...
Когда вы определились с характеристикам, запишите связанные с ними бонусы и штрафы согласно [следующим таблицам](temp).
...
Определите максимальные пункты здоровья броском кости здоровья, соответствующей выбранному классу. Обратите внимание на модификатор от Выносливости (см. [Характеристики](temp)). Персонаж начинает как минимум с 1 ПЗ.
...
Решите какого мировоззрения придерживается ваг персонаж: Закон, Нейтралитет или Хаос. Запишите выбранное мировоззрение. См. [Мировоззрение](temp) для подробного описания.

### 9. Запишите известные языки
Класс персонажа определяет ваши родные языки. Среди них всегда есть общий язык, а также язык мировоззрения (см. [Языки](temp)). Персонажи с высоким ИНТ также могут выбрать дополнительные языки, доступные в текущем мире игры.
...
- **Ловкость:** См. [Характеристики](temp).
