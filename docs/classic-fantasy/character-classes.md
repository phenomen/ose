...
Совершите проверку успешности изгнания, бросив 2d6. Затем рефери сравнивает результат проверки и значение в таблице изгнания, соответствующее кости здоровья монстра. Если результат проверки равен или выше значения в таблице, то изгнание успешно повлияло на нежить.
