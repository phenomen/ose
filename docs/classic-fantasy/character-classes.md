...
### Чуткий слух
Дворфы имеют вероятность 2-из-6 на то, чтобы услышать шум (см. [Приключения в подземельях](temp)).
...
### Чуткий слух
Полурослики имеют вероятность 2-из-6 на то, чтобы услышать шум (см. [Приключения в подземельях](temp)).
